    ...
    <div class="container">
        ...
        <div class="card rounded-0">
            <div class="card-body">
                ...
                <?php 
                    $qry = $conn->query("SELECT c.*, p.product_name, i.size, i.price, p.id as pid 
                                         FROM `cart` c 
                ...
                ?>
                    <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <img src="<?php echo validate_image($img) ?>" loading="lazy" class="cart-prod-img mr-2 border" alt="">
                            <div>
                                <p class="mb-1"><?php echo $row['product_name'] ?></p>
                                <p class="mb-1"><small><b>Size:</b> <?php echo $row['size'] ?></small></p>
                                <p class="mb-1"><small><b>Price:</b> <span class="price"><?php echo number_format($row['price'], 2) ?></span></small></p>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <button class="btn btn-sm btn-outline-secondary min-qty" type="button" id="button-addon1">
                                            <i class="fa fa-minus"></i>
                                        </button>
                                    </div>
                                    <input type="number" class="form-control form-control-sm qty text-center cart-qty" value="<?php echo $row['quantity'] ?>" aria-describedby="button-addon1" data-id="<?php echo $row['id'] ?>" readonly>
                                    <div class="input-group-append">
                                        <button class="btn btn-sm btn-outline-secondary plus-qty" type="button" id="button-addon1">
...
<script>
    ...
    function qty_change($type, _this) {
        ...
        new_total = parseFloat(qty * price).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
